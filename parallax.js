window.onload = function () {
    ...
    // Додайте обробник події для кліку на кнопку
    playButton.addEventListener('click', function () {
    // Виберіть випадковий індекс відеоролику з масиву
    const randomIndex = Math.floor(Math.random() * videoSources.length);

    // Отримайте посилання на випадковий відеоролик
    const randomVideoSource = videoSources[randomIndex];

    // Отримайте елемент відеоплеєра
    const videoPlayer = document.getElementById('videoPlayer');

    // Встановіть вибраний відеоролик як джерело для відеоплеєра
    videoPlayer.src = randomVideoSource;
    videoPlayer.load(); // Завантажити відеоролик
    });
